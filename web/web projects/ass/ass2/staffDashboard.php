...
$sql = "SELECT * FROM tickets WHERE assignedstaff = :id";
if (!empty($filters)) {
...
$statusSql = "SELECT DISTINCT status FROM tickets WHERE assignedstaff = :id";
$statusStatement = $pdo->prepare($statusSql);
$statusStatement->bindValue(':id', $_SESSION['userid']);
$statusStatement->execute();

$emergencySql = "SELECT DISTINCT emergencylevel FROM tickets WHERE assignedstaff = :id";
$emergencyStatement = $pdo->prepare($emergencySql);
$emergencyStatement->bindValue(':id', $_SESSION['userid']);
...
<body>
    ...
    while ($row = $statement->fetch()) {
        ...
        echo $ticket->displayTableForStaff();
    }
