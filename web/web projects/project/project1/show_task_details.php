...
try {
    $stmt = $pdo->prepare("SELECT t.task_id, t.name, t.description, t.priority, t.status, t.effort, ta.role, t.start_date, t.end_date
        FROM tasks t
...
<main>
    <h2>Task Details</h2>
    <form action="process_task_action.php" method="post" class="task-details-form">
        <fieldset>
